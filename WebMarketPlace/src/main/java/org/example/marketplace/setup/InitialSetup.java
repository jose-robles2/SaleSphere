...
public class InitialSetup implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Item phone = new Item("Phone", "IPhone 15", "/image", "Washington", 1199.99, 1, 4);
        Item laptop = new Item("Laptop", "Macbook Pro", "/image", "Washington", 2199.99, 5, 4);
        Item tv = new Item("TV", "Samsund 4K TV", "/image", "Washington", 999.99, 5, 4);
        Item tablet = new Item("Tablet", "iPad Pro", "/image", "Washington", 799.99, 5, 4);
        Item headphones = new Item("Headphones", "Sony Noise-Canceling", "/image", "Washington", 299.99, 5, 4);
        Item camera = new Item("Camera", "Canon EOS", "/image", "Washington", 899.99, 5, 4);
...
//        Item printer = new Item("Printer", "HP LaserJet Pro", "/image", "Washington", 249.99, 5);
        ...
        Item handgun = new Item("Handgun", "Kimber Stainless 45 Auto", "/image", "Idaho", 699.99, 3, 0);
        Item semiAutoRifle = new Item("Semi-Auto Rifle", "CMMG Mk4 B16", "/image", "Alabama", 999.99, 1, 0);
        Item shotgun = new Item("Shotgun", "Benelli M1014 12 Gauge", "/image", "Florida", 1899.99, 1, 0);

        Item moonShine = new Item("Moonshine", "Naturally brewed alcohol", "/image", "Washington", 59.99, 4, 1);
        Item vodka = new Item("Vodka", "Tito's Vodka", "/image", "California", 39.99, 4, 1);
        Item rum = new Item("Rum", "Malibu Caribbean Rum", "/image", "Oregon", 19.99, 4, 1);

        Item percocet = new Item("Percocet Painkillers", "Percocet Max Strength", "/image", "Washington", 59.99, 4, 2);
        Item oxycodone = new Item("Oxycodone Painkillers", "Oxycodone Max Strength", "/image", "Oregon", 59.99, 4, 2);
        Item hydrocodone = new Item("Hydrocodone Painkillers", "Hydrocodone Max Strength", "/image", "California", 59.99, 4, 2);

        Item tobacco = new Item("Classic Cigarettes", "Large tobacco cigarette pack", "/image", "Washington", 9.99, 4, 3);
        Item vape = new Item("Classic Vape", "Large vape pack", "/image", "Oregon", 9.99, 4, 3);
        Item marijuana = new Item("Classic Marijuana", "Large weed pack", "/image", "California", 9.99, 0, 3);
